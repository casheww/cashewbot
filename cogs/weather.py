...
class Weather(commands.Cog):
    ...
    async def get_weather(self, ctx, weather_city):
        ...
        e.add_field(name='Feels Like Temperature', value=str(res['main']['feels_like'])+'°C', inline=True)
        e.add_field(name='Min Temperature Today', value=str(res['main']['temp_min'])+'°C', inline=True)
        e.add_field(name='Max Temperature Today', value=str(res['main']['temp_max'])+'°C', inline=True)
        e.add_field(name='Atmospheric Pressure', value=str(res['main']['pressure'])+' hPa', inline=True)
